export const salutationOptions = ["Select","Dr.","Mr.","Mrs.","Ms.","Prof."];
export const eventList = ["Select","INDIACom","Webinar","BJIT","FDP","Industry 5.0"];
export const categoryList = ["Select","Research Scholar","Full Time Student","Faculty","Industry Representative"];
